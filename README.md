...
`scripts/public_space_sync.py` verifies the public Hugging Face Space runtime sha, raw handoff, final launch plan, judge brief, judge crosswalk, mock video draft, health/gate APIs, and judge-mode HTML markers.
