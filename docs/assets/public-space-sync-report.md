...
Expected sha: `aeba0eae4af5c9d8a50b46b29a2977d0cb961ccb`
Runtime sha: `aeba0eae4af5c9d8a50b46b29a2977d0cb961ccb`
...
| --- | --- | --- | --- |
| OK | Space metadata points at the expected commit | Space sha is aeba0eae4af5c9d8a50b46b29a2977d0cb961ccb; expected aeba0eae4af5c9d8a50b46b29a2977d0cb961ccb. | https://huggingface.co/api/spaces/ADJCJH/backblaze-proofframe |
| OK | Space runtime is running the expected commit | Runtime stage is RUNNING; runtime sha is aeba0eae4af5c9d8a50b46b29a2977d0cb961ccb; domain ready is True. | https://huggingface.co/api/spaces/ADJCJH/backblaze-proofframe/runtime |
...
| OK | Raw judge evidence index is public and claim-safe | Evidence index schema is proofframe.judge_evidence_index.v1; mode is pre_live_evidence_index_ready; safe_to_submit is False; links=15; blockers=10. | https://huggingface.co/spaces/ADJCJH/backblaze-proofframe/raw/main/docs/assets/judge-evidence-index.json |
...
| OK | Judge-mode HTML contains recording and sponsor markers | Markers: judge_recording_slate=True, sponsor_evidence_model=True, judge_brief_panel=True, criteria_crosswalk_link=True, evidence_index_link=True, recording_runbook_panel=True, devpost_kit_panel=True, submit_checklist_panel=True, auto_load_judge_demo=True, final_reports_pending=True. | https://adjcjh-backblaze-proofframe.hf.space/?judge=1 |
