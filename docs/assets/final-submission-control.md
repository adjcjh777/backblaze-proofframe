...
- Prize total: `$10000`
- Observed participants: `372` checked `2026-06-29 Asia/Shanghai`
...
| OK | Official Devpost event snapshot is fresh | Snapshot checked at 2026-06-29T00:44:06Z; submission open is True; age days is 0. | `docs/assets/devpost-event-snapshot.json` |
