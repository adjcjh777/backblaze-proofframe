...
- Prize total: `$10000`
- Observed participants: `358` checked `2026-06-28 Asia/Shanghai`
...
| OK | Official Devpost event snapshot is fresh | Snapshot checked at 2026-06-28T10:22:12Z; submission open is True; age days is 0. | `docs/assets/devpost-event-snapshot.json` |
