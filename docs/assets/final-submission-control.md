...
- Prize total: `$10000`
- Observed participants: `404` checked `2026-06-30 Asia/Shanghai`
...
| OK | Official Devpost event snapshot is fresh | Snapshot checked at 2026-06-30T05:12:10Z; submission open is True; age days is 0. | `docs/assets/devpost-event-snapshot.json` |
