...
- `README.md` (9671 bytes, sha256 `5a427c701ead235f...`) - Core public project overview
...
- `scripts/final_submission_control.py` (24489 bytes, sha256 `4fa1023398db5035...`) - Final submission control tower
- `docs/assets/final-submission-control.json` (16631 bytes, sha256 `0b780cc414324db5...`) - Machine-readable final control report
- `docs/assets/final-submission-control.md` (4985 bytes, sha256 `7b9e019cdff8de99...`) - Human-readable final control report
...
- `docs/assets/submission-audit-report.json` (5201 bytes, sha256 `750ce10cee4805c9...`) - Machine-readable submission audit report
- `docs/assets/submission-audit-report.md` (3887 bytes, sha256 `c78767bcfeec0b43...`) - Human-readable submission audit report
...
- `docs/evidence_package.md` (12743 bytes, sha256 `8f9519a476d6a9b5...`) - Evidence package plan
- `docs/public_claim_freeze.md` (4089 bytes, sha256 `735b9188feae74ea...`) - Verified-claim boundary
- `docs/verification.md` (8063 bytes, sha256 `581a8e05754a4f79...`) - Local, CI, Docker, and live proof runbook
...
- `docs/assets/secret-scan-report.json` (8071 bytes, sha256 `24864574a92c33bd...`) - Machine-readable secret scan report
- `docs/assets/secret-scan-report.md` (846 bytes, sha256 `c0ca2da6f14150d6...`) - Human-readable secret scan report
...
- `docs/assets/recording-assets.json` (6080 bytes, sha256 `07cadc11a3d7dfb3...`) - Machine-readable recording asset report
...
- `tasks.json` (29376 bytes, sha256 `8ca8a35e828882e4...`) - Machine-readable task board
