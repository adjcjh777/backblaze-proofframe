...
- `README.md` (7190 bytes, sha256 `1be124acc0869394...`) - Core public project overview
...
- `docs/assets/devpost-form-kit.json` (11543 bytes, sha256 `1b917545fdb3ec44...`) - Machine-readable Devpost form kit
- `docs/assets/devpost-form-kit.md` (6556 bytes, sha256 `d4adc19fba7b7d96...`) - Human-readable Devpost form kit
- `apps/web/index.html` (36252 bytes, sha256 `29c0a95a1757b5a4...`) - Browser proof ledger UI
- `docs/demo_script.md` (5245 bytes, sha256 `c160051925806534...`) - Video shot list and narration
...
- `scripts/demo_readiness.py` (8504 bytes, sha256 `06bb51f8eaeb42d7...`) - Demo recording readiness gate
- `docs/assets/demo-readiness-report.json` (3450 bytes, sha256 `82864b3155d55de6...`) - Machine-readable demo readiness report
