...
- `README.md` (13158 bytes, sha256 `d3cb3f672ac961f9...`) - Core public project overview
...
- `docs/deployment.md` (4508 bytes, sha256 `f82386ffd27860ee...`) - Public demo deployment runbook
...
- `scripts/public_space_sync.py` (54190 bytes, sha256 `b12c38f3a1da3714...`) - Public Hugging Face Space sync verifier
- `docs/assets/public-space-sync-report.json` (13959 bytes, sha256 `3da134edf4f16a5e...`) - Machine-readable public Space sync report
- `docs/assets/public-space-sync-report.md` (6117 bytes, sha256 `d8852602cb8f3fd3...`) - Human-readable public Space sync report
...
- `docs/assets/devpost-submission-preview.json` (11611 bytes, sha256 `834faddaef4a8171...`) - Machine-readable Devpost preview
...
- `docs/assets/final-submission-control.json` (24109 bytes, sha256 `c3ff3d24ddb471cf...`) - Machine-readable final control report
- `docs/assets/final-submission-control.md` (6883 bytes, sha256 `f5a0a55d11f2849f...`) - Human-readable final control report
...
- `docs/assets/submission-audit-report.json` (5925 bytes, sha256 `d857ede1409562fe...`) - Machine-readable submission audit report
- `docs/assets/submission-audit-report.md` (4459 bytes, sha256 `86b861b64a5582a8...`) - Human-readable submission audit report
...
- `docs/evidence_package.md` (20399 bytes, sha256 `b1bf2eb99da24d5b...`) - Evidence package plan
...
- `docs/assets/secret-scan-report.json` (10532 bytes, sha256 `5a3be6f2fbd53289...`) - Machine-readable secret scan report
- `docs/assets/secret-scan-report.md` (846 bytes, sha256 `d637d0f9694496e6...`) - Human-readable secret scan report
...
- `tasks.json` (58101 bytes, sha256 `35b6709f37029952...`) - Machine-readable task board
