...
- `scripts/public_space_sync.py` (81453 bytes, sha256 `5225228afd83701b...`) - Public Hugging Face Space sync verifier
...
- `docs/assets/devpost-submission-preview.json` (11704 bytes, sha256 `7168c8a968a38292...`) - Machine-readable Devpost preview
...
- `apps/web/index.html` (69266 bytes, sha256 `82044f3d69e6bea4...`) - Browser proof ledger UI
...
- `docs/assets/final-submission-control.json` (24733 bytes, sha256 `787a19c2738f50e6...`) - Machine-readable final control report
- `docs/assets/final-submission-control.md` (7203 bytes, sha256 `e9683b1ba45a880e...`) - Human-readable final control report
- `scripts/final_closeout_status.py` (18713 bytes, sha256 `a223697809ac23c8...`) - No-secret final closeout status report
- `docs/assets/final-closeout-status.json` (12150 bytes, sha256 `ec4dadf4a2ce5d11...`) - Machine-readable final closeout status
...
- `docs/assets/submission-audit-report.json` (5925 bytes, sha256 `f0b9ef2fc3c40a81...`) - Machine-readable submission audit report
- `docs/assets/submission-audit-report.md` (4459 bytes, sha256 `ba55928af98821d6...`) - Human-readable submission audit report
...
- `docs/assets/secret-scan-report.json` (11558 bytes, sha256 `36233adce2780320...`) - Machine-readable secret scan report
- `docs/assets/secret-scan-report.md` (846 bytes, sha256 `d3e83224a3bb53fa...`) - Human-readable secret scan report
...
- `tasks.json` (66140 bytes, sha256 `3aff88e0602af30c...`) - Machine-readable task board
