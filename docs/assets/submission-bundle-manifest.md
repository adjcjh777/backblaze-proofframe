...
- `docs/assets/devpost-event-snapshot.json` (2492 bytes, sha256 `ab9ac6c88fd6563e...`) - Machine-readable Devpost event snapshot
- `docs/assets/devpost-event-snapshot.md` (1443 bytes, sha256 `bbb57c3ef807eb24...`) - Human-readable Devpost event snapshot
...
- `scripts/public_space_sync.py` (54190 bytes, sha256 `adfe154947f40b24...`) - Public Hugging Face Space sync verifier
- `docs/assets/public-space-sync-report.json` (13959 bytes, sha256 `5d28a4062aadf987...`) - Machine-readable public Space sync report
- `docs/assets/public-space-sync-report.md` (6117 bytes, sha256 `90a49d29f98f65a6...`) - Human-readable public Space sync report
...
- `docs/assets/devpost-submission-preview.json` (11611 bytes, sha256 `2655e46800594466...`) - Machine-readable Devpost preview
...
- `docs/assets/judge-brief.json` (3734 bytes, sha256 `aef4233ad48887d9...`) - Machine-readable judge brief
- `docs/assets/judge-brief.md` (3000 bytes, sha256 `d737af9b08481911...`) - Human-readable judge brief
- `scripts/judge_crosswalk.py` (17642 bytes, sha256 `d9153174e330fd53...`) - Official criteria to evidence crosswalk
- `docs/assets/judge-crosswalk.json` (10219 bytes, sha256 `fdf4736dab506a58...`) - Machine-readable judge crosswalk
- `docs/assets/judge-crosswalk.md` (6157 bytes, sha256 `4f3844276f9b7cc9...`) - Human-readable judge crosswalk
...
- `docs/assets/public-video-check.json` (2579 bytes, sha256 `93e548ecf3edd47c...`) - Machine-readable public video check
...
- `docs/assets/final-submission-control.json` (24109 bytes, sha256 `445b6cdb68927b05...`) - Machine-readable final control report
- `docs/assets/final-submission-control.md` (6883 bytes, sha256 `00965fee435c0a1a...`) - Human-readable final control report
...
- `docs/assets/final-launch-plan.json` (5690 bytes, sha256 `9f5c0944ea8fe686...`) - Machine-readable final launch plan
...
- `docs/assets/submission-audit-report.json` (5925 bytes, sha256 `7247caf8b1dbb15f...`) - Machine-readable submission audit report
- `docs/assets/submission-audit-report.md` (4459 bytes, sha256 `03941e1350ab9d16...`) - Human-readable submission audit report
...
- `docs/assets/secret-scan-report.json` (10532 bytes, sha256 `837af8c5d0d4957c...`) - Machine-readable secret scan report
- `docs/assets/secret-scan-report.md` (846 bytes, sha256 `b174a5a95843fb1e...`) - Human-readable secret scan report
...
- `tasks.json` (57575 bytes, sha256 `288607dab5a2d5d0...`) - Machine-readable task board
