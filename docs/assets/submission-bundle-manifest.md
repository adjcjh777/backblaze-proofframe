...
- `README.md` (15262 bytes, sha256 `e509e6372821eb02...`) - Core public project overview
...
- `scripts/public_space_sync.py` (78076 bytes, sha256 `15d1587d8c4faf8a...`) - Public Hugging Face Space sync verifier
...
- `docs/assets/devpost-submission-preview.json` (11704 bytes, sha256 `4b34824ee32b99d3...`) - Machine-readable Devpost preview
...
- `docs/assets/final-submission-control.json` (24733 bytes, sha256 `388cb7762cc337c4...`) - Machine-readable final control report
- `docs/assets/final-submission-control.md` (7203 bytes, sha256 `c86363dba1937e51...`) - Human-readable final control report
- `scripts/final_closeout_status.py` (17602 bytes, sha256 `5fd2f0fe2735e74d...`) - No-secret final closeout status report
- `docs/assets/final-closeout-status.json` (10901 bytes, sha256 `18429d4ccf01bb98...`) - Machine-readable final closeout status
- `docs/assets/final-closeout-status.md` (2353 bytes, sha256 `449c9b68de362b16...`) - Human-readable final closeout status
...
- `docs/assets/submission-audit-report.json` (5925 bytes, sha256 `c5deee7a2250e87e...`) - Machine-readable submission audit report
- `docs/assets/submission-audit-report.md` (4459 bytes, sha256 `bafe22174aa54dbb...`) - Human-readable submission audit report
...
- `docs/evidence_package.md` (20943 bytes, sha256 `ab3ea7f726baa05d...`) - Evidence package plan
- `docs/public_claim_freeze.md` (4089 bytes, sha256 `735b9188feae74ea...`) - Verified-claim boundary
- `docs/verification.md` (10429 bytes, sha256 `4b88152d46b8b3e0...`) - Local, CI, Docker, and live proof runbook
...
- `docs/assets/secret-scan-report.json` (11558 bytes, sha256 `b1b3505c1c749074...`) - Machine-readable secret scan report
- `docs/assets/secret-scan-report.md` (846 bytes, sha256 `b0eb1f5dcb32a845...`) - Human-readable secret scan report
...
- `tasks.json` (64791 bytes, sha256 `723c9eaf983e25e0...`) - Machine-readable task board
