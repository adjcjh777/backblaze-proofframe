...
- `README.md` (8936 bytes, sha256 `b92b115be188c7e4...`) - Core public project overview
...
- `scripts/final_submission_control.py` (21985 bytes, sha256 `5f967df12b934862...`) - Final submission control tower
- `docs/assets/final-submission-control.json` (14328 bytes, sha256 `76d2d3e495bd2f49...`) - Machine-readable final control report
- `docs/assets/final-submission-control.md` (4432 bytes, sha256 `033cc14cd8594998...`) - Human-readable final control report
- `scripts/final_operator_brief.py` (12236 bytes, sha256 `f299d23223244d4a...`) - No-secret final operator brief
- `docs/assets/final-operator-brief.json` (5452 bytes, sha256 `68d1ebf45f73fc9e...`) - Machine-readable final operator brief
- `docs/assets/final-operator-brief.md` (2917 bytes, sha256 `0e02a4ceb1b842e7...`) - Human-readable final operator brief
- `scripts/submission_audit.py` (18206 bytes, sha256 `08d6552f61fcf228...`) - Pre-submit audit gate
- `docs/assets/submission-audit-report.json` (5026 bytes, sha256 `8e4fc0177a5a98ba...`) - Machine-readable submission audit report
- `docs/assets/submission-audit-report.md` (3651 bytes, sha256 `be05b951f38c7ca9...`) - Human-readable submission audit report
- `docs/evidence_package.md` (11745 bytes, sha256 `d19051971939fd29...`) - Evidence package plan
...
- `tasks.json` (25438 bytes, sha256 `0c35b9b7bf876659...`) - Machine-readable task board
