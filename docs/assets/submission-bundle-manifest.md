...
- `scripts/final_submission_control.py` (23593 bytes, sha256 `87e92a7edad2c210...`) - Final submission control tower
- `docs/assets/final-submission-control.json` (15895 bytes, sha256 `f20c7ddc1b846d96...`) - Machine-readable final control report
- `docs/assets/final-submission-control.md` (4833 bytes, sha256 `0e1630fbde88e237...`) - Human-readable final control report
...
- `docs/assets/submission-audit-report.json` (5201 bytes, sha256 `bc4d088222888170...`) - Machine-readable submission audit report
- `docs/assets/submission-audit-report.md` (3887 bytes, sha256 `a38a53fc632d982e...`) - Human-readable submission audit report
...
- `docs/assets/secret-scan-report.json` (7904 bytes, sha256 `5536c39b5495ab25...`) - Machine-readable secret scan report
- `docs/assets/secret-scan-report.md` (846 bytes, sha256 `6fe5fbdd56ae49f5...`) - Human-readable secret scan report
...
- `tasks.json` (28085 bytes, sha256 `207c6b24106e7539...`) - Machine-readable task board
