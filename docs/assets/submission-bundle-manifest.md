...
- `README.md` (15285 bytes, sha256 `4e3d9e60469f88f2...`) - Core public project overview
...
- `scripts/public_space_sync.py` (81362 bytes, sha256 `7a977718a3d2fa22...`) - Public Hugging Face Space sync verifier
...
- `docs/assets/devpost-submission-preview.json` (11704 bytes, sha256 `e0d23303e252d056...`) - Machine-readable Devpost preview
...
- `docs/assets/judge-decision-brief.json` (8137 bytes, sha256 `bbff5925ade063f8...`) - Machine-readable judge decision brief
- `docs/assets/judge-decision-brief.md` (3835 bytes, sha256 `229bced696b84abc...`) - Human-readable judge decision brief
- `scripts/judge_evidence_index.py` (13831 bytes, sha256 `efbf5dee17eab7f8...`) - Public-safe judge evidence index builder
- `docs/assets/judge-evidence-index.json` (10456 bytes, sha256 `4c6e43173ca95742...`) - Machine-readable judge evidence index
- `docs/assets/judge-evidence-index.md` (4473 bytes, sha256 `4a2d727b6dbb823b...`) - Human-readable judge evidence index
...
- `docs/assets/final-video-publish-kit.json` (5366 bytes, sha256 `344571b3ad5178c5...`) - Machine-readable final video publish kit
- `docs/assets/final-video-publish-kit.md` (2727 bytes, sha256 `3ba376d90dc228db...`) - Human-readable final video publish kit
...
- `docs/assets/final-submission-control.json` (24733 bytes, sha256 `7136b7d84bde4c88...`) - Machine-readable final control report
- `docs/assets/final-submission-control.md` (7203 bytes, sha256 `fa89162dcfa96734...`) - Human-readable final control report
- `scripts/final_closeout_status.py` (18713 bytes, sha256 `a223697809ac23c8...`) - No-secret final closeout status report
- `docs/assets/final-closeout-status.json` (12150 bytes, sha256 `31c7dc7bc5dcf266...`) - Machine-readable final closeout status
- `docs/assets/final-closeout-status.md` (2405 bytes, sha256 `0e4e126cd6981e0b...`) - Human-readable final closeout status
...
- `docs/assets/submission-audit-report.json` (5925 bytes, sha256 `601ef271fb0f4066...`) - Machine-readable submission audit report
- `docs/assets/submission-audit-report.md` (4459 bytes, sha256 `a539a26c32aed1d5...`) - Human-readable submission audit report
...
- `docs/evidence_package.md` (21079 bytes, sha256 `102413abd2c709f9...`) - Evidence package plan
- `docs/public_claim_freeze.md` (4089 bytes, sha256 `735b9188feae74ea...`) - Verified-claim boundary
- `docs/verification.md` (11145 bytes, sha256 `49049c26f2b59d1a...`) - Local, CI, Docker, and live proof runbook
...
- `docs/assets/secret-scan-report.json` (11558 bytes, sha256 `e9bd3e30c95b2ad2...`) - Machine-readable secret scan report
- `docs/assets/secret-scan-report.md` (846 bytes, sha256 `b6e6d5a0ee2126da...`) - Human-readable secret scan report
...
- `tasks.json` (65707 bytes, sha256 `f3ccc5559b7aba13...`) - Machine-readable task board
