...
- `final_submission_control.blocking_items` [blocked]: Unexpected blockers remain before audit sign-off: b2_live_proof, credential_handoff, final_recording, final_secret_scan, genblaze_live_proof, public_video Evidence: `docs/assets/final-submission-control.json`
