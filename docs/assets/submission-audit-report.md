...
- `T041A` [blocked]: Run final secret scan is not done. Evidence: `tasks.json`
...
- `final_submission_control.blocking_items` [blocked]: Unexpected blockers remain before audit sign-off: devpost_submission_checklist, final_recording, final_secret_scan, public_video, public_video_check Evidence: `docs/assets/final-submission-control.json`
