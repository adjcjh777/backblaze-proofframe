...
- Dynamic participant count: Devpost showed `343` participants during the 2026-06-28 lightweight refresh. Recheck before final submission and avoid using a stale exact count in public copy.
