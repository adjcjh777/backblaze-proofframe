...
- Dynamic participant count: Devpost showed `345` participants during the 2026-06-28 official snapshot refresh. Recheck before final submission and avoid using a stale exact count in public copy.
